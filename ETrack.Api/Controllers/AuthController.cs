    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetConfirmationToken([EmailAddress] string emailToVerify) {
            ...
            emailService.sendEmail(new EmailDto {
                ...
                Body =  emailHtml($"{baseUri}/confirmation.html?confirmation-token={confirmationToken}")
            });
            return Ok();
        }
        ...
        // [HttpPost("generate-forgot-password-token")]
        // public async Task
        ...
        private string emailHtml(string href) => $$"""
        <!DOCTYPE html>
        <html lang="en">
